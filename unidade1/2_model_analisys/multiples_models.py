...
df = pd.read_csv("df machine-learning-ufc/unidade1/dataset/Indian Livr Patient Dataset (ILPD).csv")
...
dt = DecisionTreeClassifier(min_samples_split=0.13, random_state=SEED)
